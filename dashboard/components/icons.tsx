...
export function ShieldIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3 20 6.5v5.25C20 16.77 16.62 20.78 12 22c-4.62-1.22-8-5.23-8-10.25V6.5L12 3Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 12.25 10.75 14.75 15.75 9.75" />
    </svg>
  );
}
...
export function TraceIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 6h4v4H4V6Zm12 0h4v4h-4V6ZM4 14h4v4H4v-4Zm12 0h4v4h-4v-4Z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M8 8h8M8 16h8M12 10v4" />
    </svg>
  );
}
...
export function PulseIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 12h4l2.25-6 4.5 12 2.25-6H21" />
    </svg>
  );
}
